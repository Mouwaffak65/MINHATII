...
const scholarshipsData = [
    { id: 1, title: 'منحة الحكومة الصينية 2026-2027', desc: 'منحة شاملة تغطي الرسوم الدراسية والسكن والتأمين الصحي.', deadline: '30 أغسطس 2026', level: 'جميع المستويات', country: 'الصين', documents: 'الشهادة الثانوية أو الجامعية، كشف الدرجات، جواز السفر، شهادة لغة', registerUrl: 'https://www.campuschina.org/' },
    { id: 2, title: 'منحة إيراسموس موندوس 2026', desc: 'برنامج تبادل للطلاب الدوليين مع تمويل كامل في جامعات أوروبية.', deadline: '15 سبتمبر 2026', level: 'ماجستير', country: 'أوروبا', documents: 'شهادة البكالوريوس، كشف الدرجات، السيرة الذاتية، رسالة تحفيزية، رسالتا توصية', registerUrl: 'https://erasmus-plus.ec.europa.eu/' },
    { id: 4, title: 'منحة إيراسموس موندوس 2026', desc: 'برنامج تبادل للطلاب الدوليين مع تمويل كامل في جامعات أوروبية.', deadline: '15 سبتمبر 2026', level: 'ماجستير', country: 'أوروبا', documents: 'شهادة البكالوريوس، كشف الدرجات، السيرة الذاتية، رسالة تحفيزية، رسالتا توصية', registerUrl: 'https://erasmus-plus.ec.europa.eu/' },
];
