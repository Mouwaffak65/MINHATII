...
const scholarshipsData = [
    ...
    { id: 4, title: 'منحة الحكومة الصينية 2026-2027', desc: 'منحة شاملة تغطي الرسوم الدراسية والسكن والتأمين الصحي.', deadline: '30 أغسطس 2026', level: 'جميع المستويات', country: 'الصين', documents: 'الشهادة الثانوية أو الجامعية، كشف الدرجات، جواز السفر، شهادة لغة', registerUrl: 'https://www.campuschina.org/' },
];
